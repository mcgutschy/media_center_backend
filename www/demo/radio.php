...
<body>
    <div style="background: #ffa726; color: #1a1a2e; text-align: center; padding: 0.5rem; font-weight: 700; font-size: 0.9rem; letter-spacing: 2px;">DEMO MODUS <body>mdash; <body>Auml;nderungen werden nur lokal gespeichert</div>
<div class="container">
